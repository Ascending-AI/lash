...
board: the whole workspace core suite and tail, the lane tests, the selected
store suites, and every trusted Rust job. The single `CI conclusion` job
rejects failed, cancelled, missing, or incorrectly skipped correctness jobs
and is the aggregate merge context.
