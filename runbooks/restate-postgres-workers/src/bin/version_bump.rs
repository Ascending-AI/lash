...
/// enumerate.
///
/// The retained 120 -> 121 generation (FIG-3586) introduced no relation or
/// constraint the refusal would name. Component 122 (FIG-3598) is
/// destructive: no 121 → 122 arm exists, so the component-121 stamp over the
