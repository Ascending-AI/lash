...
fn continuation_decode_rejects_inline_compound_heap_members() {
    ...
    let nested = r#"{"format_version":14,"reference_semantics":false,"instruction_pointer":0,"active_function":null,"operand_stack":[{"kind":"ref","value":1}],"pending_tools":[],"execution_nonce":0,"last_value":{"kind":"unset"},"slots":[],"globals":{"kind":"record","value":[]},"iterator_stack":[],"frame_stack":[],"handler_stack":[],"finally_stack":[],"occurrence_counters":{},"mode":"Process","profile":null,"pending_error_span":null,"instructions_executed":0,"active_execution_elapsed":{"secs":0,"nanos":0},"heap":{"next_id":3,"allocation_counter":2,"live_logical_bytes":184,"size_schedule_version":2,"objects":[{"id":1,"object":{"kind":"list","items":[{"kind":"list","value":[{"kind":"ref","value":2}]}]}},{"id":2,"object":{"kind":"list","items":[]}}]}}"#;
...
fn continuation_decode_rejects_an_active_function_without_a_root_frame() {
    ...
    let wire = r#"{"format_version":14,"reference_semantics":false,"instruction_pointer":1,"active_function":0,"operand_stack":[],"pending_tools":[],"execution_nonce":0,"last_value":{"kind":"unset"},"slots":[],"globals":{"kind":"record","value":[]},"iterator_stack":[],"frame_stack":[],"handler_stack":[],"finally_stack":[],"occurrence_counters":{},"mode":"Process","profile":null,"pending_error_span":null,"instructions_executed":1,"active_execution_elapsed":{"secs":0,"nanos":0},"heap":{"next_id":1,"allocation_counter":0,"live_logical_bytes":0,"size_schedule_version":2,"objects":[]}}"#;
...
fn slots_wire(slots: &str, objects: &str, next_id: u64, counter: u64, bytes: u64) -> String {
    format!(
        r#"{{"format_version":14,"reference_semantics":false,"instruction_pointer":0,"active_function":null,"operand_stack":[],"pending_tools":[],"execution_nonce":0,"last_value":{{"kind":"unset"}},"slots":{slots},"globals":{{"kind":"record","value":[]}},"iterator_stack":[],"frame_stack":[],"handler_stack":[],"finally_stack":[],"occurrence_counters":{{}},"mode":"Process","profile":null,"pending_error_span":null,"instructions_executed":0,"active_execution_elapsed":{{"secs":0,"nanos":0}},"heap":{{"next_id":{next_id},"allocation_counter":{counter},"live_logical_bytes":{bytes},"size_schedule_version":2,"objects":{objects}}}}}"#
    )
}
