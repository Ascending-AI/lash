...
/// same bytes.
const AUTHORED_CELL_CONTINUATION: &str = r#"{"format_version":28,"executable":"unlinked","reference_semantics":false,"instruction_pointer":0,"active_function":null,"operand_stack":[],"pending_tools":{},"execution_nonce":0,"last_value":{"kind":"unset"},"slots":[{"kind":"set","value":{"kind":"ref","value":1}}],"globals":{"kind":"record","value":[]},"iterator_stack":[],"frame_stack":[],"handler_stack":[],"finally_stack":[],"occurrence_counters":{},"mode":"Process","profile":null,"pending_error_span":null,"instructions_executed":0,"heap":{"next_id":2,"allocation_counter":1,"live_logical_bytes":88,"size_schedule_version":3,"objects":[{"id":1,"object":{"kind":"cell","value":{"kind":"number","value":{"version":1,"bits":4613937818241073152}}}}]}}"#;
...
fn a_binding_cell_decodes_and_re_encodes_exactly() {
    let continuation: VmContinuation = serde_json::from_str(AUTHORED_CELL_CONTINUATION)
        .expect("a continuation holding a binding cell should decode");
    assert_eq!(continuation.heap.live_logical_bytes(), 88);
    let re_encoded =
        serde_json::to_string(&continuation).expect("decoded continuation should encode");
    assert_eq!(re_encoded, AUTHORED_CELL_CONTINUATION);
}
...
fn continuation_decode_rejects_inline_compound_heap_members() {
    ...
    let nested = r#"{"format_version":28,"executable":"unlinked","reference_semantics":false,"instruction_pointer":0,"active_function":null,"operand_stack":[{"kind":"ref","value":1}],"pending_tools":{},"execution_nonce":0,"last_value":{"kind":"unset"},"slots":[],"globals":{"kind":"record","value":[]},"iterator_stack":[],"frame_stack":[],"handler_stack":[],"finally_stack":[],"occurrence_counters":{},"mode":"Process","profile":null,"pending_error_span":null,"instructions_executed":0,"heap":{"next_id":3,"allocation_counter":2,"live_logical_bytes":184,"size_schedule_version":3,"objects":[{"id":1,"object":{"kind":"list","items":[{"kind":"list","value":[{"kind":"ref","value":2}]}]}},{"id":2,"object":{"kind":"list","items":[]}}]}}"#;
...
fn continuation_decode_rejects_an_active_function_without_a_root_frame() {
    ...
    let wire = r#"{"format_version":28,"executable":"unlinked","reference_semantics":false,"instruction_pointer":1,"active_function":0,"operand_stack":[],"pending_tools":{},"execution_nonce":0,"last_value":{"kind":"unset"},"slots":[],"globals":{"kind":"record","value":[]},"iterator_stack":[],"frame_stack":[],"handler_stack":[],"finally_stack":[],"occurrence_counters":{},"mode":"Process","profile":null,"pending_error_span":null,"instructions_executed":1,"heap":{"next_id":1,"allocation_counter":0,"live_logical_bytes":0,"size_schedule_version":3,"objects":[]}}"#;
...
fn slots_wire(slots: &str, objects: &str, next_id: u64, counter: u64, bytes: u64) -> String {
    format!(
        r#"{{"format_version":28,"executable":"unlinked","reference_semantics":false,"instruction_pointer":0,"active_function":null,"operand_stack":[],"pending_tools":{{}},"execution_nonce":0,"last_value":{{"kind":"unset"}},"slots":{slots},"globals":{{"kind":"record","value":[]}},"iterator_stack":[],"frame_stack":[],"handler_stack":[],"finally_stack":[],"occurrence_counters":{{}},"mode":"Process","profile":null,"pending_error_span":null,"instructions_executed":0,"heap":{{"next_id":{next_id},"allocation_counter":{counter},"live_logical_bytes":{bytes},"size_schedule_version":3,"objects":{objects}}}}}"#
    )
}
...
async fn continuation_decode_rejects_shared_and_cyclic_durable_ownership() {
    ...
    let slot_and_global = format!(
        r#"{{"format_version":28,"executable":"unlinked","reference_semantics":false,"instruction_pointer":0,"active_function":null,"operand_stack":[],"pending_tools":{{}},"execution_nonce":0,"last_value":{{"kind":"unset"}},"slots":[{{"kind":"set","value":{{"kind":"ref","value":1}}}}],"globals":{{"kind":"record","value":[["kept",{{"kind":"ref","value":1}}]]}},"iterator_stack":[],"frame_stack":[],"handler_stack":[],"finally_stack":[],"occurrence_counters":{{}},"mode":"Process","profile":null,"pending_error_span":null,"instructions_executed":0,"heap":{{"next_id":2,"allocation_counter":1,"live_logical_bytes":{empty_bytes},"size_schedule_version":3,"objects":{empty_list}}}}}"#
    );
