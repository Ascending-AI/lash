// Vendored prost-build 0.14 output for ../../vendor/restate-service-protocol/protocol.proto
// (the Restate service protocol, MIT, Copyright (c) 2023 Restate Software, Inc., Restate GmbH;
// see ../../vendor/restate-service-protocol/LICENSE). It is byte-for-byte the file
// restate-sdk-shared-core 7.0.3 compiles from the same proto; regenerate it with prost-build
// from the vendored proto when the pinned shared core moves.
...
pub struct GetLazyStateCompletionNotificationMessage {
    ...
    pub result: ::core::option::Option<get_lazy_state_completion_notification_message::Result>,
}
...
pub struct GetPromiseCompletionNotificationMessage {
    ...
    pub result: ::core::option::Option<get_promise_completion_notification_message::Result>,
}
...
pub struct PeekPromiseCompletionNotificationMessage {
    ...
    pub result: ::core::option::Option<peek_promise_completion_notification_message::Result>,
}
...
pub struct CompletePromiseCompletionNotificationMessage {
    ...
    pub result: ::core::option::Option<complete_promise_completion_notification_message::Result>,
}
...
pub struct AttachInvocationCompletionNotificationMessage {
    ...
    pub result: ::core::option::Option<attach_invocation_completion_notification_message::Result>,
}
...
pub struct GetInvocationOutputCommandMessage {
    ...
    pub name: ::prost::alloc::string::String,
    #[prost(
        oneof = "get_invocation_output_command_message::Target",
        tags = "1, 3, 4"
    )]
...
pub struct GetInvocationOutputCompletionNotificationMessage {
    ...
    pub result:
        ::core::option::Option<get_invocation_output_completion_notification_message::Result>,
}
