...
fn postgres_status_list_literals_derive_from_the_shared_constant() {
    ...
    // partial process indexes in schema.sql - the live worklist, the
    // parent-end pending-cancel scan, and FIG-3795's live-generation route
    // index - whose vocabulary FIG-2811 owns.
