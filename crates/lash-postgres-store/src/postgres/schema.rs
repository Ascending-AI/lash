...
const SCHEMA_MIGRATIONS: &[SchemaMigration] = &[
    ...
    // cutover. This historical refusal-only row keeps that immediate
    // predecessor generation explicit after component 68 advances the current
    // hard-cutover boundary. It is inapplicable at open because no row targets
    // component 68.
    SchemaMigration {
        from: 66,
        to: 67,
