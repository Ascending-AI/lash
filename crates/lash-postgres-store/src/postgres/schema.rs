...
const SCHEMA_MIGRATIONS: &[SchemaMigration] = &[
    // Retain component 75 as a refusal-only edge. No row targets component 77.
    SchemaMigration {
        from: 75,
        to: 76,
    ...
    // previous freshness-state boundary; no row targets component 77,
    ...
    // boundary. It is inapplicable at open because no row targets component 77.
    SchemaMigration {
        from: 70,
        to: 76,
        source_missing_tables: &[],
