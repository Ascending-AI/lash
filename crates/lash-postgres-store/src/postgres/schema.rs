...
const SCHEMA_MIGRATIONS: &[SchemaMigration] = &[
    ...
    // Component 76 changes process-id collation and rebuilds its indexes via
    ...
    // previous freshness-state boundary; no row targets component 76,
    ...
    // boundary. It is inapplicable at open because no row targets component 76.
    SchemaMigration {
        from: 70,
        to: 75,
        source_missing_tables: &[],
