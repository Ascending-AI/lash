...
pub(super) const SCHEMA_MIGRATIONS: &[SchemaMigration] = &[
    // Retain component 84 as the refusal-only endpoint. No row targets component
    // 85: pending-input claim correlation is a reject-and-recreate cutover after
    // component 84 added attachment write tokens.
    SchemaMigration {
        from: 83,
        to: 84,
