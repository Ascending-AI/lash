...
pub(super) const SCHEMA_MIGRATIONS: &[SchemaMigration] = &[
    // Retain component 86 as the refusal-only endpoint. No row targets component
    // 87: recoverable artifact-cleanup evidence is a reject-and-recreate cutover
    // after component 86 added exact artifact ownership.
    SchemaMigration {
        from: 85,
        to: 86,
