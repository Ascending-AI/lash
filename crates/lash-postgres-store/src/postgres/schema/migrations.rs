...
pub(super) const SCHEMA_MIGRATIONS: &[SchemaMigration] = &[
    // Retain component 87 as the refusal-only endpoint. No row targets the
    // current component: admitted physical cancellation scope is a
    // reject-and-recreate cutover after component 87 added durable closure
    // authorization.
    SchemaMigration {
        from: 86,
        to: 87,
