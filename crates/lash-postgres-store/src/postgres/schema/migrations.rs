...
pub(super) const SCHEMA_MIGRATIONS: &[SchemaMigration] = &[
    // Retain component 88 as the refusal-only endpoint. No row targets the
    // current component: promise-owner lifecycle participation is a
    // reject-and-recreate cutover after component 88 added admitted physical
    // cancellation scope.
    SchemaMigration {
        from: 87,
        to: 88,
