...
pub(super) const SCHEMA_MIGRATIONS: &[SchemaMigration] = &[
    // Retain component 86 as the refusal-only endpoint. No row targets the
    // current component: durable closure authorization is a reject-and-recreate
    // cutover after component 85 added pending-input claim correlation and
    // component 86 added cancellation-intent publication fencing.
    SchemaMigration {
        from: 85,
        to: 86,
