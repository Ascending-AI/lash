//! Frozen historical declarations used to exercise source-shape and refusal checks.
//! They are excluded from the production admission catalog.
...
pub(super) const HISTORICAL_MIGRATIONS: &[SchemaMigration] = &[
    ...
    // the component-88 opener. Their original refusal and DDL contracts remain
