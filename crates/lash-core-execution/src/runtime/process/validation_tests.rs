...
fn process_registration_identity_golden_corpus() {
    ...
    enriched.identity = crate::ProcessIdentity::for_definition(
    ...
    let expected = [
        (
            "",
            "process-registration-definition:v8:blake3:e2dbe6ca57d012d8398fa57e8e803677a6c23b0b8bd6c91d4c28641937b6283a",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:08562c062552db66bfb01403a5aa63e98c478b99381fc26adb30fe178be68395",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:c8a19d86307fcb80dabd331bda741ab018e7a32c8794c4dafb22c5144b2fbded",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:04e709f0b4cf86edaa276a7e843f7e9b6978c46926628853d0fcece718bee4fa",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:128daecea192684a446a971872bd81532a94dd878b52f9cfc6c1317002108725",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:f8e43c5b23791c06cd687d8c97f9096c194ec228f5e445407ee901bc8a6e27e1",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:ac661c7191175746d9b37b92ff570ed9e67b64010b0e3aab60cc42d0d0f86b9e",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:7d9a2d93bfe9a289cf4b58fae0b3856b51930175e466cad62800e65bba0e31bb",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:c9112ee8ee91b3faaa191f07ffcbb705142a2f0b3bca171748e7899797a3ef7a",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:d7ee1ac793097824c9b8d25cbe006631234cdb45e78d8c5455cc25e7d65a3f88",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:59ae30731087808139e67e2b80b2bb356f52aa5565d12fa31cd6c69c4d7a4ac7",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:43beefe3d08821336d990fcd28fc6bbbb8e444caacc8b4d121e44cab37df6d3a",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:b0efc3e7b1ac697722dfe59404b38d1874e737f4ba7184662d369905015eb0aa",
        ),
        (
            "",
            "process-registration-definition:v8:blake3:9bc05ed88287600dd1f3456c0178e8c8d401f7601bd32abf911e672f44873fb6",
        ),
    ];
...
/// Frozen predecessor witness (FIG-2992): the v6 preimage of an
/// identity-bearing registration carried the identity's kind, label and
/// definition blob (`6b696e64` = "kind", `613a62` = "a:b"). The v7 family
/// dropped them and v8 keeps them out, so the historical bytes are frozen here
/// and must never be produced again by the current projection.
#[test]
fn process_registration_v6_identity_bytes_are_frozen_out_of_the_v7_preimage() {
    const FROZEN_V6_PREIMAGE: &str = "";
    const FROZEN_V6_KEY: &str = "process-registration-definition:v6:blake3:7877bd6a141400a2245a9a416d4ad86b1f72a1adea241b3a86c0869ef47b2b93";

    let mut registration = registration_for_input(ProcessInput::External {
        metadata: serde_json::Value::Null,
    });
    registration.identity = crate::ProcessIdentity::for_definition(
        crate::ProcessDefinitionRef::unclaimed("kind", serde_json::json!({"definition": 0})),
        Some("a:b"),
    );
    let preimage = hex(&super::process_registration_fingerprint_preimage(
        &registration,
        &[],
    ));
    assert!(
        !preimage.contains("00000000000000046b696e64"),
        "the post-v6 preimage must not carry the identity kind"
    );
    assert!(
        !preimage.contains("0000000000000003613a62"),
        "the post-v6 preimage must not carry the identity label"
    );
    assert!(FROZEN_V6_PREIMAGE.starts_with("6c6173682d737461626c652d6964656e7469747902"));
    assert_ne!(
        process_registration_fingerprint(&registration, &[]),
        FROZEN_V6_KEY
    );
}
...
fn replay_route_participates_in_the_current_process_registration_family() {
    ...
    assert!(without_route.starts_with("process-registration-definition:v8:blake3:"));
    ...
    assert!(routed.starts_with("process-registration-definition:v8:blake3:"));
...
fn lifecycle_and_resolved_attempts_are_registration_identity() {
    ...
    registration.lifecycle.parent = crate::ParentScope::process(crate::ProcessRef::new(
        crate::ProcessId::from("parent"),
    ...
    registration.lifecycle.parent = crate::ParentScope::process(crate::ProcessRef::new(
        crate::ProcessId::from("parent"),
        crate::ProcessIncarnation::from_registration_sequence(8),
    ));
