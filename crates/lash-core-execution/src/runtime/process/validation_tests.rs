...
fn process_registration_identity_golden_corpus() {
    ...
    let expected = [
        (
            "",
            "process-registration-definition:v7:blake3:35dd33da36d9829ead01f5d366c23d0069c7cfbb9d9abab2d2f9cbb0ae77e2d3",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:b8bef638e9e1f99aab57041f4cd115dc3dfad51abb79b38f2cd25e07aab35e84",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:a90bf15a81a514c566088d8fbad2264fb327f40c0086231ee37b28623c4d815c",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:b9d15fca7e0eac7961158ca65f975ae0d1dcb606de27284b667160061e0efc42",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:1f6fed58ba39aeb87b6fb6acb20f1da2302b5f74cdcc21756e97b474dafab00e",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:9fd49fbf2940f1e1fb9b420cbe4d17f6b7ffb529ec7156567456d51c551a9191",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:bb5da197d7cf29d7e181ed969dd958aa16861ed25517ffd6ef8b8e023172c315",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:8ccebd4bfa6c30e453a8378623d1b64cbe8a4db836fd537e1fa9177b6d61e1be",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:b036486fc60e3e86a370df4d7036d76fa3c400503132bcaea6c2ade7f11850dc",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:01fa4ac2cc9ea4e611fe08bbc2daaaa78d3b5ebb7b48223bce12cf03a1081d83",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:32806a3e46543729d105f8b68d74891dfa4aada6b43101be8b576a664ff8d37f",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:b04f86246725e5b5da78ffe1dd1e8a37646841ebe3bbeb7a9b8e8ce17510cc64",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:7c003b2f49e402481e2f1b65868085a243326a8912303d4e60b9dd70bcc20c2e",
        ),
        (
            "",
            "process-registration-definition:v7:blake3:3d232ccf2fec4a2aa36e93b25129e237a7a9c30d5ea83bd55f7163db0397e08f",
        ),
    ];
...
/// definition blob (`6b696e64` = "kind", `613a62` = "a:b"). The v7 family drops
/// them, so the historical bytes are frozen here and must never be produced
/// again by the current projection.
#[test]
fn process_registration_v6_identity_bytes_are_frozen_out_of_the_v7_preimage() {
    ...
    assert!(
        ...
        "the v7 preimage must not carry the identity kind"
    );
    assert!(
        !preimage.contains("0000000000000003613a62"),
        "the v7 preimage must not carry the identity label"
    );
...
fn replay_route_participates_in_the_current_process_registration_family() {
    ...
    assert!(without_route.starts_with("process-registration-definition:v7:blake3:"));
    ...
    assert!(routed.starts_with("process-registration-definition:v7:blake3:"));
