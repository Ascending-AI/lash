...
pub mod process {
    ...
    pub use lash_core::{
        ...
        CausalRef, DEFAULT_PROCESS_EFFECT_OCCURRENCE_CAP, DeclaredProcessIdentity, HandleId,
        NativeProcessWork, OnParentEnd, PARENT_SCOPE_STORAGE_PAYLOAD_VERSION,
        PROCESS_EFFECT_OUTCOME_EVENT_TYPE, PROCESS_EVENT_VOCABULARY_VERSION, ParentScope,
        ParentScopeStorageError, ProcessArtifactCleanupAck, ProcessAwaitOutput,
        ...
        ProcessEventPageMore, ProcessEventPageToken, ProcessEventQueryMode,
