...
// Window 57: FIG-2765 carries the typed usage disposition on attempt records
...
// Window 64: FIG-2866 redacts agent-frame seed bodies from tool-call observation controls.
