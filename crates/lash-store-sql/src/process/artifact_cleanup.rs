...
//!
//! One row per pruned incarnation, holding what the caller needs to release
...
pub const INSERT_COLUMNS: &str = "process_id, incarnation, cleanup_json";
...
crate::statements! {
    ...
    pub struct ArtifactCleanupStatements @ "process_artifact_cleanup" {
        /// Every outstanding cleanup, oldest incarnation first. The caller
