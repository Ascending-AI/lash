...
pub const INSERT_COLUMNS: &str = "session_id, process_index, process_id, process_incarnation";
...
pub const INTENT_COLUMNS: &str = "process_index, process_id, process_incarnation";
...
crate::statements! {
    ...
    pub struct ObserverIntentStatements @ "session_meta_observer_intent" {
        ...
        select_for_session = "SELECT process_index, process_id, process_incarnation
