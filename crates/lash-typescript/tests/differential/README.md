...
240 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 527 rows carry
454 distinct expressions.
