...
254 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 541 rows carry
468 distinct expressions.
