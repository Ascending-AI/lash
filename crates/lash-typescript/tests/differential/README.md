...
476 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 763 rows carry
690 distinct expressions.
