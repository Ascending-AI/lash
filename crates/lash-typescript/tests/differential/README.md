...
413 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 700 rows carry
627 distinct expressions.
