...
301 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 588 rows carry
515 distinct expressions.
