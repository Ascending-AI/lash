...
296 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 583 rows carry
510 distinct expressions.
