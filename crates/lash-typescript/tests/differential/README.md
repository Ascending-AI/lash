...
274 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 561 rows carry
488 distinct expressions.
