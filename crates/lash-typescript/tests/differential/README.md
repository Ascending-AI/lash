...
344 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 631 rows carry
558 distinct expressions.
