...
386 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 673 rows carry
600 distinct expressions.
