...
437 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 724 rows carry
651 distinct expressions.
