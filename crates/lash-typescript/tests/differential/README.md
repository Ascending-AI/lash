...
395 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 682 rows carry
609 distinct expressions.
