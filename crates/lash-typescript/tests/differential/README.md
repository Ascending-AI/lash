...
366 focused rows for the combined fix findings. Duplicate expressions are
retained so the provenance counts stay executable: the table's 653 rows carry
580 distinct expressions.
