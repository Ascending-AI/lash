...
// `{a: 1} + 1` (tsc TS2365), `TS_CONSTRUCTOR_UNSUPPORTED` on
// `new Map(1, 2)` (TS2554), and the `TS_METHOD_UNSUPPORTED` of
// `const [a] = null;` (TS2488) — are pinned by the same-named census
// probes.
// tsc TS2304.
rejection_test!(
