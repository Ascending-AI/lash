...
/// Every method a built-in prototype of the ECMA-262 (and WHATWG URL) surface
/// defines, as Node v25.2.1 lists them. A member call spelling one of these is
/// classified by the dialect's stdlib surface; any other name is a method of
/// the program's own objects.
const ECMA_PROTOTYPE_METHODS: &[&str] = &[
    "__defineGetter__",
    "__defineSetter__",
    "__lookupGetter__",
    "__lookupSetter__",
...
pub(super) fn is_ecma_prototype_method(method: &str) -> bool {
    ECMA_PROTOTYPE_METHODS.contains(&method)
}
