...
fn process_registration_identity_golden_corpus() {
    ...
    let expected = [
        (
            "",
            "process-registration-definition:v2:blake3:0424bf28c1e864649cb5048a1a43eb5960c0c186de7b5cfe858974b784edb481",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:ab66466de8d0af0d665f674ffce4d5c9819dac19e792307fd416f42a9e01f3d6",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:71f07a2e8b759a17721ca3d86e282481d40e64f82ada9a2e26211bb98d783754",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:381ec4350456431158897518c15dabf76124ba177d4527f70c6ac85bc16a532b",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:a4703e5edc0721c63e163acdd17a29655875a26c44148577578a763e3e3198f1",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:87a284597964fd37f7aff74a35c561d6d92036d1369511a42240cdf5c678bb97",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:3704d26af23274cacd46f0ea298ac435e9e4d83cb85913a5669b75df5a61cc53",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:e33794452e2aada7e6d3465e5c4c6e5304077093b2e2edceace0751c1a774463",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:9944b75c05cdfac76a7617b0e8887573a4ee2fa5d0ac8f464a910662d175dc85",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:ef16a864d6ac4ea03345dd3f7750a725c4f0d2513d5b678ed4e97a823dc645d8",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:e0fa81f289a2ea461aa014502f150e32e76b71edf6feb863855101f7f7f80866",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:131b1db31ef5fd1aa6b11673ec54212441052133f79efb20054cde6950495430",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:91beea090bd67ba4ec4373779f7017e27155c727d8ab7a8326119f60d190e5a5",
        ),
        (
            "",
            "process-registration-definition:v2:blake3:3bc0260cf5cb2e111b4cd1773c16f1fcb863c0834c1759df54bffbc105543dfe",
        ),
    ];
...
fn replay_route_rotates_process_registration_to_the_current_family_without_moving_v2() {
    ...
    assert!(legacy.starts_with("process-registration-definition:v2:blake3:"));
    ...
    assert!(routed.starts_with("process-registration-definition:v4:blake3:"));
