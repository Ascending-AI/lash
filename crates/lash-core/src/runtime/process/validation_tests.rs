...
fn process_registration_identity_golden_corpus() {
    ...
    let expected = [
        (
            "",
            "process-registration-definition:v5:blake3:2894316a07f80eda8a87214932677b6ba4935650890dfb8cbf038e510278281b",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:4f0d316b3b96c72326384db4035a0e64bf4385f253244ae6a18b445c6c9bf9e1",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:e6195a78361da393d434404e2cf3525aa50f920def0bcf4471f7bac29b9cd997",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:7d1c81d17b7202bea0c12e5842c980299190c772a69dac76c9ef2697e519f7bd",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:7cf99af0ccd5cad3b44bf29cfe4e0634cd84ade19c935cee39a6f8fa257c2ca8",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:1b3b0efd68486acf3f874a3b209a5ab9796bde53f73ead6ec846671a62ae1b04",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:6d1303291a398be7b2837ab0e324cd1ee936d9fc42d1d06248d6ce0b1bd823f1",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:bb2b7dd3942fac8a068754ac8fdec168f6d45b6d53e7e9607d2f5e88790966b4",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:a21bdaa4f29c440da33fbe59a62a40eef8449af41b0dfb8db5e403aff2e2dccb",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:c32ca94708509d69ab0117bdebb0cd320890920468d6fc1874a5fedc0578527a",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:03fe250069dd2b07094d9e0d3a2e362154da6e54e068025c33987d573a44bc2b",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:0851157a871a799f889512adea71beefcfbe8df4e1b20f6de51e95841d7d3eda",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:9649fc525120ac95132396e8ec449397a7a3494f44620239a3a5cf4c6fd406c0",
        ),
        (
            "",
            "process-registration-definition:v5:blake3:b10ee4be7e00e6dbe31a2b3c362aad5b26bf83deace9d5ab043089c1103caa0e",
        ),
    ];
...
fn replay_route_participates_in_the_current_process_registration_family() {
    ...
    assert!(without_route.starts_with("process-registration-definition:v5:blake3:"));
    ...
    assert!(routed.starts_with("process-registration-definition:v5:blake3:"));
