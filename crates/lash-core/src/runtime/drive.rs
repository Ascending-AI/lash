...
//! admitted root. Nothing downstream of admission branches on store state the
//! engine did not record: a redrive replays the admission and the seal, and
//! the root replays its recorded claim and the head that claim was admitted
//! on (FIG-3682).
//!
