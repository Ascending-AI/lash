...
pub mod store_backend_support {
    ...
    pub use process_lifecycle_sql::{
        live_process_status_predicate_sql, retired_process_status_predicate_sql,
        undelivered_wake_delivery_state_predicate_sql, wake_delivery_state_sql_literal,
    };
...
pub use runtime::{
    ...
    ProcessRef, ProcessRegistrar, ProcessRegistration, ProcessRegistrationDisposition, ProcessRegistrationOutcome,
    ProcessRegistrationProbe, ProcessRegistry,
