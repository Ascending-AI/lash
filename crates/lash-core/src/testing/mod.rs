...
pub fn process_engine_fixture() -> crate::ProcessEngineRegistry {
    crate::ProcessEngineRegistry::new().with_engine(Arc::new(FixtureProcessEngine))
}
...
impl crate::PluginFactory for FixtureProcessEngineFactory {
    ...
    ) -> Result<Vec<Arc<dyn crate::ProcessEngine>>, crate::PluginError> {
        Ok(vec![Arc::new(FixtureProcessEngine)])
    }
