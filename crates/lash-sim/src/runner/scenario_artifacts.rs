...
pub(super) fn write_generated_backend_regression_fixtures(
    ...
    for spec in specs {
        ...
        let backend_equivalence_contract = "source seed passed the dynamic generated workload substrate differential (the serialized SQLite memory and file runs agree); static SQLite/Postgres replay is a different fixed-order trace contract and is not inferred from this generated trace";
