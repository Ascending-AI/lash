...
async fn pending_tool_completion_proof_runs_on_the_restate_server_double() {
    ...
    for seed in 0x5eed_7001_u64..0x5eed_7001 + 20 {
        ...
        let (_, again, _) = pending_tool_completion_on_the_restate_server_double(seed).await;
