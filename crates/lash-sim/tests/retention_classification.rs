...
const CENSUS: &[(&str, RetentionClass)] = &[
    ...
    (
        "turn_park_clock",
        PermanentlyExempt {
            reason: "singleton monotone park-feed sequence and compaction horizon",
        },
    ),
    (
        "turn_park_events",
        Bounded {
            lever: "compact_turn_park_feed",
        },
    ),
    (
        "process_park_clock",
    ...
    (
        ...
        LifecycleOwned {
            scope: "the condemning sweep: a completed delete retires the row, abandonment releases it, and a restoring write revokes it",
        },
    ),
    (
        "artifact_refs",
