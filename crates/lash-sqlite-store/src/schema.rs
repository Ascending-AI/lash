...
// Version 20 rejects the retired trigger-list envelope shape. Version 19 is
// reserved by the concurrent artifact-lifecycle cutover in PR #1297; older
// journals are recreated rather than replayed across this encoding cutover.
