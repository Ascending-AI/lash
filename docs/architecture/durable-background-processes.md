...
Figments coordination is one Lash revision. SQLite durable-core schema <span data-format-version="SQLITE_SCHEMA_VERSION">39</span> includes
...
immutable graph-generation cutover. PostgreSQL schema <span data-format-version="POSTGRES_SCHEMA_VERSION">58</span> includes those cutovers,
