...
writes ingress rows (the frame follow-on is a session-head fact). Sections 5 and
6 stand. Section 5(b)'s exemption does not let a lane-less turn commit ahead of
a pending follow-on (ADR 0101 §3). References below to ADR 0010 read as ADR
0101.
