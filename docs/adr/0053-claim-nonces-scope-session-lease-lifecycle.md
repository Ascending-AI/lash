...
specifies SQL-engine behaviour: the claim nonces and fencing generation of the
SQL session-execution lease. Those passages stay as written until the PR that
