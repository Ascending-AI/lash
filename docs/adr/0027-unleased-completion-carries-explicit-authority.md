...
specifies SQL-engine behaviour: the split between completion under a Lash
process lease and unleased completion. Those passages stay as written until the
