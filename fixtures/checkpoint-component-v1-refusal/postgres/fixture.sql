...
CREATE TABLE lash_durable_read_fixture.lash_pending_turn_inputs (
    ...
    CONSTRAINT ck_pending_turn_inputs_bound_claim_is_next_turn CHECK (((claim_bound_turn_id IS NULL) OR ((claim_token IS NOT NULL) AND (state = 'deferred_next_turn'::text)))),
...
INSERT INTO lash_durable_read_fixture.lash_graph_nodes VALUES ('durable-read-fixture', 'n_a4ce52601dca198bf0f1df46a748ede0704fe4f823ce2c3fa4128b8ad37b20ac', 'frame-node/v3/1eea72aaea89086d6bc4149c359256b8e3a459bbafee748808da3e69e7888940', 1, 'frame-node/v3/1eea72aaea89086d6bc4149c359256b8e3a459bbafee748808da3e69e7888940', '{"schema_version":22,"timestamp":"2023-11-14T22:13:20+00:00","kind":"event","event":{"Conversation":{"id":"m_append_5b56214e4aa13f5f64634578e4b3af5426535c9018989aa3e92e2f5637692ff6","role":"User","parts":[{"id":"m_append_5b56214e4aa13f5f64634578e4b3af5426535c9018989aa3e92e2f5637692ff6.p0","kind":"Text","content":"durable read user message"}],"origin":{"kind":"plugin","plugin_id":"plugin"}}}}', false);
