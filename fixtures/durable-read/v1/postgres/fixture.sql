...
CREATE TABLE lash_durable_read_fixture.lash_session_meta (
    ...
    CONSTRAINT ck_session_meta_relation_family CHECK ((((relation_kind = 'root'::text) AND (parent_session_id IS NULL) AND (caused_by_kind IS NULL) AND (source_session_id IS NULL) AND (source_node_id IS NULL) AND (observer_inheritance_kind IS NULL)) OR ((relation_kind = 'child'::text) AND (parent_session_id IS NOT NULL) AND (source_session_id IS NULL) AND (source_node_id IS NULL) AND (observer_inheritance_kind IS NULL)) OR ((relation_kind = 'fork'::text) AND (parent_session_id IS NULL) AND (caused_by_kind IS NULL) AND (source_session_id IS NOT NULL) AND (source_node_id IS NOT NULL) AND (observer_inheritance_kind IS NOT NULL)) OR ((relation_kind IS NOT NULL) AND (NOT (relation_kind = ANY (ARRAY['root'::text, 'child'::text, 'fork'::text])))))),
...
INSERT INTO lash_durable_read_fixture.lash_graph_nodes VALUES ('durable-read-fixture', 'frame-node/v3/1eea72aaea89086d6bc4149c359256b8e3a459bbafee748808da3e69e7888940', NULL, 0, 'frame-node/v3/1eea72aaea89086d6bc4149c359256b8e3a459bbafee748808da3e69e7888940', '{"schema_version":17,"timestamp":"2023-11-14T22:13:20+00:00","kind":"frame_open","frame_key":"frame-key/v2/c9b08bd8c779c300744ed4d57455bc2d2166e56c7b2b2783b2fa9db331ef66e6","reason":"initial","assignment":{"policy":{"model":{"id":"","variant":"provider_default","limits":{"context_window_tokens":1}},"provider_id":"","session_id":null,"autonomous":false,"turn_budget":"unbounded"},"plugin_options":{}},"protocol_turn_options":{"schema_version":1,"payload":{}}}', false);
INSERT INTO lash_durable_read_fixture.lash_graph_nodes VALUES ('durable-read-fixture', 'n_3246dccf4a810defd9cc125efda53f1ac7be7acd0a13c98aa3b3e4d1c7f4bb08', 'frame-node/v3/1eea72aaea89086d6bc4149c359256b8e3a459bbafee748808da3e69e7888940', 1, 'frame-node/v3/1eea72aaea89086d6bc4149c359256b8e3a459bbafee748808da3e69e7888940', '{"schema_version":17,"timestamp":"2023-11-14T22:13:20+00:00","kind":"event","event":{"Conversation":{"id":"m_append_9304aea3269b249d9b8e240f046976a16b2a95e618eb374edf1eded586a60e3c","role":"User","parts":[{"id":"m_append_9304aea3269b249d9b8e240f046976a16b2a95e618eb374edf1eded586a60e3c.p0","kind":"Text","content":"durable read user message","prune_state":"Intact"}],"origin":{"kind":"plugin","plugin_id":"plugin"}}}}', false);
INSERT INTO lash_durable_read_fixture.lash_graph_nodes VALUES ('durable-read-fixture', 'n_03531bbc4371c54580f1b7874194d0d85964dba1d26654a91b77dc19b6b1c19a', 'n_3246dccf4a810defd9cc125efda53f1ac7be7acd0a13c98aa3b3e4d1c7f4bb08', 2, 'frame-node/v3/1eea72aaea89086d6bc4149c359256b8e3a459bbafee748808da3e69e7888940', '{"schema_version":17,"timestamp":"2023-11-14T22:13:20+00:00","kind":"plugin","plugin_type":"durable-read-plugin","body":{"fixture":true,"order":2}}', false);
...
INSERT INTO lash_durable_read_fixture.lash_release_stamp VALUES (true, '0.0.0-dev', 'lash-postgres-store=105', 1700000000000);
...
INSERT INTO lash_durable_read_fixture.lash_trigger_mutation_receipts VALUES ('trigger-operation:v2:blake3:d53259dcf40a55e423a5392198cae3383e86089d874f1294ec29183c9a874a4f', 'trigger-command:v6:blake3:856c9bb689ee094ff80cf15559ef868bba0272b640be5c5d8be659696ecbbcc3', '{"Ok":{"_owner_scope_namespace":"session:durable-read-fixture","receipt":{"definition_fingerprint":"trigger-definition:v3:blake3:a359a0f8b9619d0aa56a03b9a45ffaaa89c69ad02e3e9f45a7311249b8ee4df3","disposition":"created","enabled":true,"incarnation":"durable-read-trigger-incarnation","owner_scope":{"session_id":"durable-read-fixture","type":"session"},"record_snapshot":{"created_at_ms":1700000000000,"definition_fingerprint":"trigger-definition:v3:blake3:a359a0f8b9619d0aa56a03b9a45ffaaa89c69ad02e3e9f45a7311249b8ee4df3","env_ref":"process-env:v6:blake3:4999a9eb5f1038bea76c7d1c114893c28c91b7fd479339f4b1edf60314744738","event_types":[],"incarnation":"durable-read-trigger-incarnation","input_template":{"event":{"type":"event"}},"lifecycle":{"lifecycle":"enabled"},"name":"Durable read trigger","owner_scope":{"session_id":"durable-read-fixture","type":"session"},"payload_schema":{"schema":{"additionalProperties":false,"properties":{"value":{"type":"integer"}},"required":["value"],"type":"object"}},"registrant":{"session_id":"durable-read-fixture","type":"session"},"revision":1,"source":{"fixture":"source"},"source_capture":{"config_schema":{"schema":{"additionalProperties":false,"properties":{"fixture":{"type":"string"}},"type":"object"}},"constructor_path":["fixture","event"],"route":{"kind":"provider","provider_id":"fixture-provider","route":{"account":"fixture"}}},"source_key":"fixture-source","source_type":"fixture.event","subscription_id":"trigger-subscription:v2:blake3:65d03d5aa96e165d6e48392576cb9dba7e571ae2df15f9947dae596f902e1d74","subscription_key":"durable-read-trigger","target":{"kind":"durable-read-trigger-target","payload":{"fixture":"trigger"},"type":"engine"},"target_identity":{"definition":{"definition":{"fixture":"trigger"},"engine_kind":"durable-read-trigger-target","signature":{"signature":"unknown"}},"kind":"durable-read-trigger-target","label":"Durable read trigger target"},"target_label":"Durable read trigger target","updated_at_ms":1700000000000,"wake_target":{"session_id":"durable-read-fixture"}},"revision":1,"subscription_id":"trigger-subscription:v2:blake3:65d03d5aa96e165d6e48392576cb9dba7e571ae2df15f9947dae596f902e1d74","subscription_key":"durable-read-trigger"},"type":"mutation"}}', 1700000000000);
